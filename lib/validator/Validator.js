...
Validator.prototype = {
    ...
    compare: function(specs) {
        ...
        specs.forEach(function(spec) {
            ...
            // TODO there should be only ONE feature per spec!
    ...
    _mergeSpec: function(spec, error) {
        ...
        if (tests.length > 1) {
            ...
            tests.slice(1).forEach(function(test) {
                ...
                // Check if the tags of all extra tests match the feature's
                ...
                // Check if the titles of all extra tests match the feature's
                if (test.getTitle() !== feature.getTitle()) {
                    error.addFeatureError(feature, {
                        type: 'title',
                ...
                // Check if the description of all extra tests match the feature's
                // TODO line locations are incorrectly reported in both test and feature files
                if (test.getDescription() !== feature.getDescription()) {
                    error.addFeatureError(feature, {
                        type: 'description',
