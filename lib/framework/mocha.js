...
var Test = require('../test/Test'),
    Scenario = require('../test/Scenario'),
    Expectation = require('../test/Expectation'),
    ...
    parse: function(filename, commentPrefix) {
        ...
        ast.traverse(tree.program.body, function(node) {
            ...
            ast.traverse(describeNode.expression.arguments[1].body, function(node) {
                ...
                // TODO fix this, this is incorrect!! these need to be applied after sorting by line
                var index = 0;
                ...
                // Sort expectations based on line in file
                scenario.getExpectations().sort(function(a, b) {
                    return a.getLocation().line - b.getLocation().line;
                });

                // TODO caculate and appyl comment index
