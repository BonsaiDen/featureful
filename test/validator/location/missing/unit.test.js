    ...
    it('should not report expected locations for Features and Tests when using Tag matching', function(done) {
        ...
        framework.match(__dirname, function(specs) {
            ...
            result.getFeature('Feature A').getErrors().should.be.eql([{
                ...
                from: {
                    col: 0,
                    filename: '/home/ivo/Desktop/featureful/test/validator/location/missing/features/a.feature',
                    line: 2
                },
                location: null,
            ...
            result.getFeature('Feature B').getErrors().should.be.eql([{
                ...
                from: {
                    col: 0,
                    filename: '/home/ivo/Desktop/featureful/test/validator/location/missing/tests/b.test.js',
                    line: 2
                },
                location: null,
            ...
            result.getFeature('Feature A').format().split(/\n/).should.be.eql([
                ...
                '      "Feature A"',
                '',
                '  at /home/ivo/Desktop/featureful/test/validator/location/missing/features/a.feature (line 2, column 0)',
                '',
            ...
            result.getFeature('Feature B').format().split(/\n/).should.be.eql([
                ...
                '      "Feature B"',
                '',
                '  at /home/ivo/Desktop/featureful/test/validator/location/missing/tests/b.test.js (line 2, column 0)',
                '',
