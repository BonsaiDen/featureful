describe('Multi Validation', function() {
    ...
    it('should validate that multiple Features for the same Feature share the same Tags', function(done) {
        ...
        framework.match(__dirname, function(specs) {
            ...
            result.getFeature('A Feature').getErrors().should.be.eql([{
                ...
                from: {
                    filename: root + '/test/validator/specMergeFeatures/tagMismatch/features/a_1.feature',
                    line: 2,
                    col: 0
                },
                location: {
                    filename: root + '/test/validator/specMergeFeatures/tagMismatch/features/a_2.feature',
                    line: 2,
                    col: 0
                }
            }]);
